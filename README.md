...
This library is used by [UpscaleDB](https://github.com/cruppstahl/upscaledb), the  [Tantivy search engine](https://github.com/tantivy-search/tantivy), Redis' [RediSearch](https://github.com/RedisLabsModules/RediSearch) and by the  [Trinity Information Retrieval framework](https://github.com/phaistos-networks/Trinity).
